...
const SignUp = () => {
  ...
  <div class="flex w-1/2 bg-gradient-to-tr from-blue-800 to-purple-700 i justify-around items-center">
    <div>
      <h1 class="text-white font-bold text-4xl font-sans">FlatFinderPro</h1>
  ...
  <div class="flex w-1/2 justify-center items-center bg-white">
    <form class="bg-white">
      ...
      <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
        ...
        <input class="pl-2 outline-none border-none" type="text" name="" id="" placeholder="Enter Email" />
      </div>
      <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 24 24" stroke="currentColor">
